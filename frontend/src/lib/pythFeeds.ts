/**
 * Pyth Network price feed IDs and REST fetcher.
 * Shared between usePythPrices (SSE stream) and avantisApi (REST fallback for cold load).
 */
 ...
 * Used as fallback when SSE stream hasn't delivered yet (cold load).
 *
